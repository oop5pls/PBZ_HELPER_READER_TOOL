...
A small local Flask tool for reading PBZ bank statements and generating spending summaries, charts, Excel reports and in case you use PostgresSQL you can also add the uploads to your database by filling out your local database info.
...
This app is intended to run locally on the user's machine. It does not intentionally send uploaded statements or transaction data to any external server. Users are responsible for keeping their own financial files, generated reports, database files, and credentials private.
